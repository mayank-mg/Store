    ...
    render() {
        ...
        return (
                            ...
                            (value)=>( 
                                <div className="img-container p-5" onClick={()=>value.handleDetails(id)}>
                                    ...
                                    <button className="cart-btn" disabled={inCart?true:false} onClick={()=>{value.addToCart(id); value.openModal(id);}}>
                                        {inCart ? <p className="text-caitalize mb-0"> In incart</p>: <i className="fas fa-cart-plus"/>}
                                        </button>
                                    </div> 
                                     )
                        }
            ...
            <div className="card-footer  d-flex justify-content-between">
                ...
                <h5 className="text-blue mb-0"><span>${price}</span></h5>
            </div>
...
&:hover{
    .card{
        ...
        box-shadow:2px 2px 5px 0x rgba(0,0,0,0.2);
    }
    .card-footer{
